...
from azure.storage.blob import BlobServiceClient  # install pip install azure-storage-blob
import pyodbc
import os
import uuid
import requests
from opencensus.ext.azure.log_exporter import AzureLogHandler  # install pip install opencensus-ext-azure
import logging
